...
echo -e "${RED} #        AUTOSCRIPT CREATED BY MJ-NET         #    "
echo -e "${RED} #      -----------About Us------------         #    "
echo -e "${RED} #    OS  DEBIAN 7-8-9  OS  UBUNTU 14-16-18     #    "
echo -e "${RED} #       Truemoney Wallet : 097-1722729        #    "
echo -e "${RED} #               { VPN / SSH }                  #    "
echo -e "${RED} #         BY : NINEMAN               #    "
echo -e "${RED} #    FB : https://m.me/hisomancup       #    "
echo -e "${RED} =============== OS-32 & 64-bit =================    "
...
echo -e "\033[35;1m
----------------------------------------------
[√] ระบบสคริป  : NINEMAN MJ-NET 
[√] ระบบพร้อมทำงาน
[√] TRUE-WALLET 097-1722729
----------------------------------------------
${NC} "
...
END
	...
	echo "<pre>by NINEMAN | MJ-NET</pre>" > /home/vps/public_html/index.html
...
http_port $PROXY
acl nineman src 127.0.0.1/32 ::1
acl to_nineman dst 127.0.0.0/8 0.0.0.0/32 ::1
...
echo ""
	cd /usr/local/bin
wget -q -O m "https://raw.githubusercontent.com/Manplus1150/mj/master/Menu"
